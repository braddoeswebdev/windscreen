Windscreen::Application.routes.draw do
  resources :flashers


  resources :meta

  get 'noctrl' => 'welcome#noctrl', :as => 'noctrl'
  get 'noscreen' => 'welcome#noscreen', :as => 'noscreen'

  get "control/" => 'control#index', :as => :control
  post "control/cue" => 'control#cue', :as => :cue_screen
