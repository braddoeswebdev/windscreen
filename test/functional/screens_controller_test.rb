...
class ScreensControllerTest < ActionController::TestCase
  ...
  test "should create screen" do
    assert_difference('Screen.count') do
      post :create, screen: { approved: @screen.approved, base: @screen.base, enabled: @screen.enabled, name: @screen.name, notes: @screen.notes, user_id: @screen.user_id }
    end
  ...
  test "should update screen" do
    put :update, id: @screen, screen: { approved: @screen.approved, base: @screen.base, enabled: @screen.enabled, name: @screen.name, notes: @screen.notes, user_id: @screen.user_id }
    assert_redirected_to screen_path(assigns(:screen))
  end
